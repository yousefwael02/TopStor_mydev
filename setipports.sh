...
then
	stamp=`date +%s%N`
	/pace/etcdput.py $clusterip sync/ipports/Add_${myhost}/request ipports_$stamp.
	/pace/etcdput.py $clusterip sync/ipports/Add_${myhost}/request/$leader ipports_$stamp.
fi
